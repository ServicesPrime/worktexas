...
export default {
    ...
    setup() {
        ...
        const disabled = inject('disabled', true); // El segundo argumento es el valor predeterminado en caso de que no se encuentre la variable proporcionada
...
<template>
    <div class="md:flex md:space-x-4 mb-5">
        <div class="md:w-1/2">
            <FormField label="Nombre del rol:" :required="true"
        ...
        <div class="md:w-1/2">
            <FormField label="Descripción:" :required="true"
            ...
            <div class="mt-2">
                <div class="relative">
                    ...
                    <input type="search" id="default-search"
                        ...
                        v-model="inputSearchModule" placeholder="Enter a search parameter" @change="searchModule">
            ...
            <div class="mt-4">
                <div class="flex flex-col space-y-2">
                    <a v-for="(module, key) in modulesFilter" :key="key" :href="`#${module.key}`" :id="`pill-${module.key}`"
                        ...
                        aria-selected="true" v-text="module.name">
                    </a>
            ...
            <div class="mt-2">
                <div class="mb-5">
                    <BaseButtons type="justify-start" no-wrap>
                        ...
                        <BaseButton color="danger" :icon="mdiReplyAll" small label="NINGUNO"
